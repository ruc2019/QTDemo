...
void SelectionBox::CheckTower(int x, int y)
{
    ...
    SubBut[0].SubImgPath = QString(":/image/beifeng.png");

    SubBut[1].SubX = mx + 14, SubBut[1].SubY = my + 106;
    SubBut[1].SubImgPath = QString(":/image/kelifulan.png");

    SubBut[2].SubX = mx + 202, SubBut[2].SubY = my + 106;
    SubBut[2].SubImgPath = QString(":/image/wuqi.png");

    SubBut[3].SubX = mx + 106, SubBut[3].SubY = my + 190;
    SubBut[3].SubImgPath = QString(":/image/qiye.png");
